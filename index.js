...
// ANSWER: The size is all dependent on the length of the string for both functions. 
...
// CODE HERE 
let num =  new factorial()
console.log(num.calcFac(4))
...
*/
let ob = new clas()
console.log(ob.reverseString('word'))
